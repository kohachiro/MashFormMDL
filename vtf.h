...
struct VTFFileHeaderV7_1_t : public VTFFileBaseHeader_t 
{
	...
	Vector			reflectivity;					// This is a linear value, right?  Average of all frames?
...
inline ImageFormat D3DFormatToImageFormat( D3DFORMAT format )
{
	switch(format)
	{
	case D3DFMT_R8G8B8:
...
inline D3DFORMAT ImageFormatToD3DFormat( ImageFormat format )
{
